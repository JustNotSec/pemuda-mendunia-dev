<!-- Testimonials -->
<div class="overflow-hidden bg-red-800">
  <div class="relative max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    ...
    <div class="max-w-2xl w-3/4 lg:w-1/2 mb-6 sm:mb-10 md:mb-16">
      ...
      Video Testimoni dan Harapan Alumni
      </h2>
    </div>
    <!-- End Title -->
...
<div class="flex h-auto">
  <div class="flex flex-col bg-white rounded-xl">
    <div class="flex-auto">
      <iframe 
        class="w-92 h-56 md:h-64 rounded-t-xl" 
        src="https://www.youtube.com/embed/CM9jlzxTax0?si=p4QfG0_dz9rpUEdE" 
    ...
    <div class="p-4 bg-gray-100 rounded-b-xl md:px-7">
      <div class="flex items-center gap-x-3">
        <div class="shrink-0">
          <img class="size-8 sm:h-[2.875rem] sm:w-[2.875rem] rounded-full object-cover object-[left_90%]" 
               src="https://pemudamendunia.com/wp-content/uploads/2024/09/Logo-05-e1727523129671.png" 
               alt="Avatar">
        </div>
...
<div class="flex h-auto">
  <div class="flex flex-col bg-white rounded-xl">
    <div class="flex-auto">
      <iframe 
        class="w-92 h- md:h-64 rounded-t-xl" 
        src="https://www.youtube.com/embed/xC2z9-gn0wY?si=vTTupYBVbXqzkaZC" 
        title="YouTube video player" 
        frameborder="0" 
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
        allowfullscreen>
...
<div class="flex h-auto">
  <div class="flex flex-col bg-white rounded-xl">
    <div class="flex-auto">
      <iframe 
        class="w-92 h-56 md:h-64 rounded-t-xl" 
        src="https://www.youtube.com/embed/c_XiYs1W8NE?si=2UnsfdEEToMfirg7"
        title="YouTube video player" 
        frameborder="0" 
        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" 
        allowfullscreen>
